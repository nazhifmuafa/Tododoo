...
class UpdateTask extends StatefulWidget {
  @override
  final Data item;
  UpdateTask({Key? key, required this.item}) : super(key: key);

  State<UpdateTask> createState() => _UpdateTaskState(taskItem: item);
}

class _UpdateTaskState extends State<UpdateTask> {
  final Data taskItem;
  _UpdateTaskState({required this.taskItem});
  var controller = Get.find<HomeController>();

  //@override
  void initState() {
    super.initState();
    controller.taskId.value.text = taskItem.idTask.toString();
    controller.taskName.value.text = taskItem.name!;
    controller.taskDescription.value.text = taskItem.description!;
    controller.taskDueDate.value.text = taskItem.dueDate.toString();
    controller.taskCategory.value.text = taskItem.category!;
    controller.taskPriority.value.text = taskItem.priority!;
    controller.taskReminder.value.text = taskItem.reminder.toString();
    controller.taskRepeat.value.text = taskItem.repeatTask!;
  }
